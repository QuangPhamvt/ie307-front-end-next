...
const HeaderComponent: React.FC = () => {
  ...
  return (
    <View className="relative flex w-full flex-row items-center justify-between bg-black p-2">
      ...
      <TouchableOpacity onPress={() => navigation.navigate("NewPostView")}>
        <Text className="font-bold text-sky-600 ">Next</Text>
      </TouchableOpacity>
    </View>
  )
}
